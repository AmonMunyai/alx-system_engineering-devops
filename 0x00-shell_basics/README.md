...
3-listfiles
Display's current working directory in a long format.

4-listmorefiles
Display's current working directory contents, including hidden files (starting with .). Using long format.
